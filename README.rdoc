...
The original repo is dead https://github.com/MYchaieb/user_signature_redmine
I'm updating the plugin to work with the new redmine versions.
...
search this ligne ( ligne 800 )  safe_attributes 'firstname', and add 'user_signature', to that collection.
